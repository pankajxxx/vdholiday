                                        ...
                                        <label class="custom-control-label text-lh-inherit text-color-1" for="review_score_<?php echo e($number); ?>">
                                            <div class="d-inline-flex align-items-center font-size-13 text-lh-1 text-primary">
                                                <div class="green-lighter ml-1 letter-spacing-2">
                                                    <?php for($review_score = 1 ;$review_score <= $number ; $review_score++): ?> <i class="fa fa-star"></i>
                                                        <?php endfor; ?>
                                                </div>
                                            </div>
                                        </label>
                    ...
                    <div class="border-0">
                        ...
                        <div id="context-filter-price" class="collapse show" data-parent="#bravo-filter-price">
                            <div class="card-body pt-0 ">
                                ...
                                <input class="filter-price" type="text" name="price_range" data-extra-classes="u-range-slider height-35" data-type="double" data-grid="false" data-hide-from-to="true" data-min="<?php echo e($price_min); ?>" data-max="<?php echo e($price_max); ?>" data-from="<?php echo e($pri_from); ?>" data-to="<?php echo e($pri_to); ?>" data-prefix="<?php echo e($currency['symbol'] ?? ''); ?>" data-result-min="#rangeSliderMinResult" data-result-max="#rangeSliderMaxResult">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border-0">
                        ...
                        <div id="attr_more_<?php echo e($item->id); ?>" class="collapse show" aria-labelledby="cityCategoryHeadingOne" data-parent="#attr_<?php echo e($item->id); ?>">
                            <div class="card-body pt-0 mt-1  pb-4">
                                ...
                                <?php if($key <= 2 ): ?> <?php $translate=$term->translate(); ?>
...
</div><?php /**PATH C:\wamp64\www\vdholiday\themes/Mytravel/Flight/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>