...
<script>
    function __checkedSegement(offerArrIndex) {
        ...
        // $.ajax({
        //     url: "<?php echo e(route('flight.__getOfferDetails')); ?>",
        //     type: 'POST',
        //     data: {
    ...
    $(document).on("click", ".checkUpsellDetails", function() {
        ...
        $.ajax({
            url: "<?php echo e(route('flight._getUpsellDetails')); ?>",
            type: 'POST',
            data: {
                'offerArrIndex_': offerArrIndex_,
                'flightSearchToken_': flightSearchToken_,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\vdholiday\themes/Mytravel/Flight/Views/frontend/search.blade.php ENDPATH**/ ?>