<header id="header" class="<?php if(!empty($is_home) or !empty($header_transparent)): ?>
        ...
        <?php endif; ?>" data-header-fix-moment="500" data-header-fix-effect="slide">
...
</header><?php /**PATH C:\wamp64\www\vdholiday\themes/Mytravel/Layout/parts/header.blade.php ENDPATH**/ ?>