...
<div class="bravo_footer mt-4 border-top">
    ...
    <div class="border-top border-bottom border-color-8 space-1">
        <div class="container">
            ...
            Copyright @ SATGURU TRAVEL AND TOURISM PRIVATE LIMITED 2024, All rights reserved.
        </div>
    </div>
...
<script>
    var save_cookie_url = '<?php echo e(route('
    core.cookie.check ')); ?>';
</script>
...
<?php \App\Helpers\ReCaptchaEngine::scripts() ?><?php /**PATH C:\wamp64\www\vdholiday\themes/Mytravel/Layout/parts/footer.blade.php ENDPATH**/ ?>