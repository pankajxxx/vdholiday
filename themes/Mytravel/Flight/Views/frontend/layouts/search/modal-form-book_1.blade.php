<div id="{{ $rows['offerArr']['index'] }}" class="js-modal-window u-modal-window max-width-960" data-modal-type="ontarget" data-open-effect="fadeIn" data-close-effect="fadeOut" data-speed="500">
			...
			<div class="row align-items-center text-center">
				<div class="col-md-auto mb-4 mb-md-0">
					<div class="d-block d-lg-flex flex-horizontal-center">
						<img class="img-fluid mr-3 mb-3 mb-lg-0 max-width-10" :src="flight.airline.image_url??''" {{-- src="https://satgurudmc.com/reseller/assets/thumbnail?src=air:UX.jpg&h=40" --}} alt="Image-Description">
